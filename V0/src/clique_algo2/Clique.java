...
public class Clique {
	...
	public Clique(VertexSet _clique,int edge){
		this._clique = new VertexSet(_clique);
		this._clique.add(edge);
	}
	...
	public int potenialSize() 
	{
		return this._clique.size() + this._Ni.size();
	}
